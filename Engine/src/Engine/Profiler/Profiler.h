...
#define ENGINE_PROFILE_BEGIN_SESSION(name, filepath) ::Engine::Profiler::Get().BeginSession(name, filepath)
#define ENGINE_PROFILE_END_SESSION() ::Engine::Profiler::Get().EndSession()
#define ENGINE_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Engine::ProfilerUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Engine::ProfileTimer timer##line(fixedName##line.Data)
