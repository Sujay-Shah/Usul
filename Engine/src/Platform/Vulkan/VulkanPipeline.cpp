...
namespace Engine {
    ...
    VulkanPipeline::VulkanPipeline(const std::shared_ptr<VulkanDevice>& device, const std::string& vertShaderPath, const std::string& fragShaderPath, VkFormat colorAttachmentFormat)
        : m_device(device), m_vertShaderPath(vertShaderPath), m_fragShaderPath(fragShaderPath) {
    }
    ...
    {
        createRenderPass(VK_FORMAT_B8G8R8A8_SRGB);
    ...
    void VulkanPipeline::createRenderPass(VkFormat colorAttachmentFormat)
    {
